// Deprecated: HashiCorp is no longer publishing new versions of the prebuilt provider for external.
...
// You can continue to use the external provider in your CDK for Terraform projects with newer versions of CDKTF,
