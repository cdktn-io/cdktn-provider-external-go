...
import (
	...
	"github.com/cdktn-io/cdktn-provider-external-go/external/v12/dataexternal/internal"
...
func (j *jsiiProxy_DataExternal) CdktfStack() cdktn.TerraformStack {
...
func (j *jsiiProxy_DataExternal) ForEach() cdktn.ITerraformIterator {
...
func (j *jsiiProxy_DataExternal) Lifecycle() *cdktn.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataExternal) Provider() cdktn.TerraformProvider {
...
func (j *jsiiProxy_DataExternal) Result() cdktn.StringMap {
...
func (j *jsiiProxy_DataExternal) TerraformGeneratorMetadata() *cdktn.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataExternal)SetForEach(val cdktn.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataExternal)SetLifecycle(val *cdktn.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataExternal)SetProvider(val cdktn.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataExternal_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktn.TerraformProvider) cdktn.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataExternal) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (d *jsiiProxy_DataExternal) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
